...
// router.route('/coaches').get(ciamController.hasCookie, marketingController.getAllCoachDetails);
router.route('/coaches').get(marketingController.getAllCoachDetails);
// router.route('/coach-profile').get(marketingController.getCoachDetails);
...
// router.route('/coach-edit').get(marketingController.getCoachDetails);
